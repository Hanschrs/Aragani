	...
	<div id="carousel-home" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="<?= base_url(); ?>assets/images/lomba/img_homescreen.jpg" alt="Aragani 1" width="1920" height="500">
			</div>
			<div class="carousel-item">
				<img src="<?= base_url(); ?>assets/images/lomba/img_homescreen2.jpg" alt="Aragani 2" width="1920" height="500">
			</div>
			<!-- <div class="carousel-item">
