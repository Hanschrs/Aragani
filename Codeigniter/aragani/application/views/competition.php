	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-header">
				<img class="modal-title" src="<?= base_url(); ?>assets/images/logo/mahakarya_logo_icon.png">
			...
			<div class="modal-body row">
				<div class="col-md-6">
					<img class="gambar-lomba" src="<?= base_url(); ?>assets/images/lomba/img_futsal.jpg">
				</div>
				<div class="col-md-6">
...
<div class="modal fade" id="modal2">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="col-md-6">
					<img class="gambar-lomba" src="<?= base_url(); ?>assets/images/lomba/img_photography.jpg">
				</div>
				<div class="col-md-6">
...
<div class="modal fade" id="modal3">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="col-md-6">
					<img class="gambar-lomba" src="<?= base_url(); ?>assets/images/lomba/img_dance.jpg">
				</div>
				<div class="col-md-6">
...
<div class="modal fade" id="modal4">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="col-md-6">
					<img class="gambar-lomba" src="<?= base_url(); ?>assets/images/lomba/img_basket.jpg">
				</div>
				<div class="col-md-6">
...
<div class="modal fade" id="modal5">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="col-md-6">
					<img class="gambar-lomba" src="<?= base_url(); ?>assets/images/lomba/img_journalistics.jpg">
				</div>
				<div class="col-md-6">
...
<div class="modal fade" id="modal6">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="col-md-6">
					<img class="gambar-lomba" src="<?= base_url(); ?>assets/images/lomba/img_band.jpg">
				</div>
				<div class="col-md-6">
...
<div class="modal fade" id="modal7">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="col-md-6">
					<img class="gambar-lomba" src="<?= base_url(); ?>assets/images/lomba/img_poster.jpg">
				</div>
				<div class="col-md-6">
